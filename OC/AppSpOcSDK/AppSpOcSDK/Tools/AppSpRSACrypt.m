...
@implementation AppSpRSACrypt

+ (NSString *)encryptString:(NSString *)originalString {
    return [self encryptString:originalString publicKey:[AppSpConfig getRsaPublicKey]];
}

+(NSString *)decryptString:(NSString *)ciphertextString{
    return [self decryptString:ciphertextString privateKey:[AppSpConfig getRsaPrivateKey]];
}
